...
const CameraSlot = ({
  ...
  return (
    ...
    >
      <div className="wrapper" id={'wrapper-slot-' + slotIndex}>
        {loading && (
          <StyledLoading>
        ...
        {camera && camera?.uuid && camera?.uuid !== '' && (
          <>
            ...
            <StyledCameraBottom>
              <StyledCameraName>{!isClose && camera.name}</StyledCameraName>
              {isRecording && (
                <StyledCountdown>
